...
import { AddVerificationTransactions1788924000000 } from "./migrations/1788924000000-add-verification-transactions.js";
...
export default new DataSource({
  ...
  migrations: [
    ...
    AddVerificationTransactions1788924000000,
  ],
});
